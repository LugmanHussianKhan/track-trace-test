    ...
    <main className="w-full min-h-screen">
      ...
      <section className="max-w-5xl mx-auto py-14">
        <div className="w-full text-center max-w-2xl mx-auto">
          <h1 className="text-5xl font-bold max-w-3xl text-center mx-auto leading-tight">One stop solution for all you shipment tracking</h1>
          <div className="flex items-center gap-2 mt-10 justify-between">
            ...
            />
            <Button className="" onClick={onSearch}>Track</Button>
          </div>
